...
* Ensure your reverse proxy supports **WebSocket upgrade headers**.
* Configure tenant-aware routing and session or token flows correctly.
...
* **Contracts & Entitlements**
  ...
  * service eligibility
  * SLA per contract
  * included services per client organization
...
* **Incident / Problem / Change Management**
  ...
  * broader ITSM expansion beyond ticket handling
...
* **Time Tracking & Billing Support**
  ...
  * track effort per ticket or project
...
* **Advanced SLA Calendars**
  ...
  * holidays
  * contract-based response windows
